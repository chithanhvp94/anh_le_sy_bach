		...
		initializeFrame: function(settings) {
			...
			this.frame.on('open', function() {
				...
				// Adjust modal level related properties
				{
					...
					// fixes https://github.com/ThemeFuse/Manager/issues/2167
					$modal.css('z-index', '');
			...
			onSubmit: function(e) {
				...
				view.model.getValuesFromServer(view.$el.serialize())
					.done(function (response, status, xhr) {
						 ...
						 * Fixes https://github.com/ThemeFuse/Manager/issues/1998#issuecomment-248671721
						 */
			...
			jQuery.ajax({
				...
				success: function (response, status, xhr) {
					...
					if (_.isEmpty(modal.get('values'))) {
						// fixes https://github.com/ThemeFuse/Manager/issues/1042#issuecomment-244364121
						modal.set(
							'values',
