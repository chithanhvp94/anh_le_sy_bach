(function ($, fwe) {
	...
	var init = function () {
		...
		if (tinyMCEPreInit.mceInit[ id ]) {
			...
			tinyMCEPreInit.mceInit[ id ].setup = function(ed) {
				...
				ed.once('init', function (e) {
					...
					editor.on('change', function(){
						editor.save();
						$textarea.trigger('change'); // fixes https://github.com/ThemeFuse/Manager/issues/2273
					});
			...
			// fixes https://github.com/ThemeFuse/Manager/issues/1615
			if (typeof window.wpLink != 'undefined') {
				try {
					// do not do .open() // fixes https://github.com/ThemeFuse/Manager/issues/1901
