...
class FW_Db_Options_Model_Settings extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param null|bool $get_original_value REMOVED https://github.com/ThemeFuse/Manager/issues/1676
		 *
		 * @return mixed|null
		 */
...
class FW_Db_Options_Model_Customizer extends FW_Db_Options_Model {
	...
	protected function _init() {
		...
		// Fixes https://github.com/ThemeFuse/Manager/issues/2053
		add_action('customize_preview_init', array($this, '_reset_cache'),
			1 // Fixes https://github.com/ThemeFuse/Manager/issues/2104
		);
	}
}
