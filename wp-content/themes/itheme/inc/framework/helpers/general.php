 ...
 * https://github.com/ThemeFuse/Manager/commit/07be8b1f4b50eaf0f1f7e85ea1c6912a0415d241#diff-cf866bf08b8f747e3120221a6b1b07cfR48
...
function fw_get_google_fonts_v2() {
	...
	if (
		...
		$response = wp_remote_get( apply_filters( 'fw_googleapis_webfonts_url',
			'http://google-webfonts-cache.Manager.io/v1/webfonts' ) );
...
function fw_current_url() {
	...
	if ( $url === null ) {
		...
		//https://github.com/ThemeFuse/Manager/issues/2442
		...
		) { // https://github.com/ThemeFuse/Manager/issues/126
