...
class FW_WP_Option
{
	 ...
	 * @param bool|null $get_original_value REMOVED https://github.com/ThemeFuse/Manager/issues/1676
	 * @return mixed|null
	 */
	public static function get($option_name, $specific_multi_key = null, $default_value = null, $get_original_value = null)
	{
		if ( ! is_null($get_original_value) ) {
			_doing_it_wrong(__FUNCTION__, '$get_original_value parameter was removed', 'Manager 2.5.8');
		}
