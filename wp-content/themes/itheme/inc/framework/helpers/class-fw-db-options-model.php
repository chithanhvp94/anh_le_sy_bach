...
abstract class FW_Db_Options_Model {
	...
	final public function get( $item_id = null, $option_id = null, $default_value = null, array $extra_data = array() ) {
		...
		if ($options) {
			try {
				FW_Cache::get(
					// fixes https://github.com/ThemeFuse/Manager/issues/2034
				 ...
				 * Fixes https://github.com/ThemeFuse/Manager/issues/2034#issuecomment-248571149
				 */
	...
	final public function set( $item_id = null, $option_id = null, $value, array $extra_data = array() ) {
		...
		if ($option_id) {
			...
			if (empty($value)) {
				...
				// Fixes https://github.com/ThemeFuse/Manager/issues/2179
		...
		FW_Cache::del($cache_key_values); // fixes https://github.com/ThemeFuse/Manager/issues/1538
