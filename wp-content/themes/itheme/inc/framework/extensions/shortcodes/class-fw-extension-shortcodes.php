...
class FW_Extension_Shortcodes extends FW_Extension
{
	...
	protected function _init()
	{
		 ...
		 * https://github.com/ThemeFuse/Manager/issues/1807#issuecomment-235243578
		 */
		add_action(
			'wp_enqueue_editor',
		...
		add_action(
			 ...
			 * http://manual.Manager.io/en/latest/extension/shortcodes/index.html#enqueue-shortcode-dynamic-css-in-page-head
