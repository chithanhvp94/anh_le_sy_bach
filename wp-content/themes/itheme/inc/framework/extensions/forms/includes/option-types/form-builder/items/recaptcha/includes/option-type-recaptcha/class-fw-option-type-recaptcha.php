	...
	protected function _get_defaults() {
		return array(
			...
			'inner-options' => array(
				'site-key'    => array(
					'label' => __( 'Site key', '' ),
					'desc'  => __( 'Your website key. More on how to configure ReCaptcha', 'Manager' ) . ': <a href="https://www.google.com/recaptcha" target="_blank">https://www.google.com/recaptcha</a>',
					'type'  => 'text'
				),
				'secret-key'    => array(
					'label' => __( 'Secret key', '' ),
					'desc'  => __( 'Your secret key. More on how to configure ReCaptcha', 'Manager' ) . ': <a href="https://www.google.com/recaptcha" target="_blank">https://www.google.com/recaptcha</a>',
					'type'  => 'text'
				),
			),
			'value'         => array()
