...
$manifest['uri'] = 'http://manual.Manager.io/en/latest/extension/forms/index.html';
$manifest['author'] = 'ThemeFuse';
$manifest['author_uri'] = 'http://themefuse.com/';
$manifest['github_repo'] = 'https://github.com/ThemeFuse/Manager-Forms-Extension';
$manifest['version'] = '2.0.31';
$manifest['standalone'] = false;
$manifest['display'] = false;
$manifest['github_update'] = 'ThemeFuse/Manager-Forms-Extension';
