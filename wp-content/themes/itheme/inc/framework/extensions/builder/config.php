 ...
 * @since 1.2.0
 *
 * old $cfg['default_item_widths'] https://github.com/ThemeFuse/Manager-Builder-Extension/issues/8
 * https://github.com/ThemeFuse/Manager-Builder-Extension/blob/v1.1.17/config.php#L13
 */
