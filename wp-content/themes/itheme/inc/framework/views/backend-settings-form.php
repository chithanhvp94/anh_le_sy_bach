...
<script type="text/javascript">
	jQuery(function ($) {
		...
		$(formSelector).addClass('prevent-all-tabs-init'); // fixes https://github.com/ThemeFuse/Manager/issues/1491
		...
		fwForm.initAjaxSubmit({
			...
			loading: function(elements, show) {
				if (show) {
					...
					return 500; // fixes https://github.com/ThemeFuse/Manager/issues/1491
				} else {
